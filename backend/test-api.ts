...
const CONFIG = {
  ...
  operation: 'generate' as 'generate' | 'merge',
  
  // Model configuration
  modelConfig: {
    provider: 'groq' as 'groq' | 'cohere' | 'mock',
  ...
  generation: {
    ...
    // },
    constraints: {
      style: 'creative' as 'brief' | 'detailed' | 'creative',
  ...
  merge: {
    ...
    mergeStrategy: 'synthesize' as 'synthesize' | 'combine' | 'abstract' | 'contrast',
